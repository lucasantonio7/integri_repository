<template>
  <div class="integri">
    <v-container grid-list-md text-xs-center>
      <v-layout row wrap>
        <v-flex xs12>
          <h3 class="display-2 white--text">Bem vindo!</h3>
          <p class="headline white--text pr-5 pl-5">O Integri conecta indivíduos a práticas do bem através de uma vasta rede de conteúdo e oportunidade</p>
        </v-flex>
        <v-flex xs12 md4>
